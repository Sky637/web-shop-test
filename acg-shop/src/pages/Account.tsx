...
export const Account: React.FC<AccountProps> = ({ currentUser }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-10 pb-20">
      ...
      {/* 🚀 3. 修改標題區塊：加入 flex 排版與跳轉按鈕 */}
      <div className="flex justify-between items-end mb-8 border-b pb-4">
        <h1 className="text-3xl font-bold text-gray-900">帳戶詳情資料</h1>
        <button
          onClick={() => navigate('/account/barcode')}
          className="bg-purple-100 hover:bg-purple-200 text-purple-700 px-4 py-2 rounded-md text-sm font-bold transition-colors"
        >
          查看會員條碼
        </button>
      </div>
